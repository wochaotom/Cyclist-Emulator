...
## 4. Run the model
The model is the notebook `notebooks/model_v5.ipynb`. Install Python 3, then the libraries it needs, and open it:
```
...
## Where things live
- `notebooks/model_v5.ipynb` — the model (open it with Jupyter)
