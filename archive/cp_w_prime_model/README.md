...
It has been **retired as the canonical model** in favour of the dynamic, time-stepping model in [`../../notebooks/model_v5.ipynb`](../../notebooks/model_v5.ipynb). It is kept here as:
