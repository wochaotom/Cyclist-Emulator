...
| `cyclist_constant_references.pages` | Notes on physical constants / parameters. | ⚠️ Apple **Pages** format — only opens on Mac/iOS. Export to PDF (`File → Export To → PDF…`) and commit that too so Windows teammates can read it. |
