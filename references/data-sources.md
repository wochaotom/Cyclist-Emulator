...
- **CdA (drag area, TT position):** TT specialist ≈ 0.20–0.23 m²; climber/road position ≈ 0.24–0.27 m². [García-López 2008, doi:10.1080/02640410701501697](https://doi.org/10.1080/02640410701501697) (wind tunnel, pros); [BestBikeSplit](https://www.bestbikesplit.com/blog/cda-aerodynamic-drag-coefficient-cycling). No measured female-specific TT CdA exists in the published literature; any female value is scaled from male/anthropometric data (estimate, not measured).
...
- **Tokyo (Fuji Speedway lap):** no official numeric profile is published, so this entry is a reconstruction. Gradients in `tokyo_olympic_tt.csv` follow the real elevation points in the [NBC Olympics breakdown](https://www.nbcolympics.com/news/cycling-101-courses) (591 → 455 → 676 → 590 → 591 m); segment distances are set to the official 22.1 km lap (NBC's own distance breakdown appears to describe a shorter early-spec loop, so distances are not taken from it). This yields ~390 m of climbing per lap. **Quoted totals conflict:** cyclingstage/Wikipedia give ~846 m for the men's two laps (≈423 m/lap), UCI's own preview ~900 m (≈450 m/lap), and the official UCI/IOC release gives no figure — all above the modeled ~390 m, so the paper should disclose the spread rather than assert one value. The earlier Cyclingnews preview pitches (8.9%/11%) were prose and are not used. In-circuit ramp cross-check: [VeloViewer Fuji Speedway segment](https://veloviewer.com/segments/16466365) (0.86 km / 4.4%).
